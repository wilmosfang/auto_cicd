...
Vagrant.configure("2") do |config|
  ...
  # uncomment below line to share files with hosts
  #config.vm.synced_folder ".", "/auto", type: "nfs"
  config.vm.hostname = "auto"
  ...
  # software package
   ...
   config.vm.provision "shell",inline: "echo 'env is up, follow this link to access the web:\nhttp://10.1.0.155:8080\ndefault password:\nadmin/admin'", run: "always"
  # prepare env
  # config.vm.provision "shell", inline: <<-SHELL
  #     echo "hello"
  # SHELL
